    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Database</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.database.store')}}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group row">
                                <label for="inputTitle3" class="col-sm-2 col-form-label">File SQL<span style="color: red;">*</span></label>
                                <div class="col-sm-10">
                            ...
                            <div>
                                ...
                                <!-- Akhir Modal Simpan -->
                                <a href="{{route('admin.database.index')}}" class="btn btn-warning btn-sm">kembali</a>
                            </div>
                            <br>
                    </div>
                    </form>

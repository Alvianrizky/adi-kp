                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('guru.store')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" name="alamat" id="alamat" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputTitle3" class="col-sm-2 col-form-label">Email<span style="color: red;">*</span></label>
                                <div class="col-sm-10">

    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('guru.monitoring.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="inputTitle3" class="col-sm-2 col-form-label">image<span style="color: red;">*</span></label>
                                <div class="col-sm-10">
